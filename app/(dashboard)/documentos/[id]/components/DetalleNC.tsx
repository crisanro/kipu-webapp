// app/(dashboard)/documentos/[id]/components/DetalleNC.tsx
"use client";
...
export default function DetalleNC({ factura }: Props) {
  ...
  return (
    <>
      ...
      {detalles.length > 0 && (
        <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-800">
            <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Ítems acreditados</h2>
          </div>
                ...
                <div key={i} className="px-4 py-3">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-sm font-semibold text-purple-400">-${fmt(item.precioTotalSinImpuesto)}</p>
                      {tarifa && <span className="text-xs text-gray-500">IVA {tarifa}%</span>}
                    </div>
                  </div>
                </div>
              );
      ...
      {/* Totales */}
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
        <h2 className="text-xs font-semibold text-gray-500 mb-3 uppercase tracking-wide">Valor de Modificación</h2>
        <div className="space-y-2 text-sm">
